...
- `sensitivity_run/`: uncertainty-radius sensitivity outputs
- `calibration_run/`: target-sample calibration outputs

Intermediate smoke tests, refresh runs, and earlier radius-specific variants have been removed from this repository snapshot to keep the bundled outputs focused on the final paper results.
